...
This skill needs the Atlassian MCP server. It is not auto-started by the plugin —
add it to your project's `.mcp.json` and set the credentials in your environment:
