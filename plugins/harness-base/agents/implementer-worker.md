...
description: Executes ONE bounded task from the planner's plan in an isolated context (supervisor-worker topology). Has Edit/Write/Bash. Returns a typed diff summary. Invoke once per task.
