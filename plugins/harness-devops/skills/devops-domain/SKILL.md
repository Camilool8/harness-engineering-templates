---
name: devops-domain
description: Shared rules for any DevOps work — trust model, the propose-never-apply cardinal rule, GitOps means write to Git not the cluster, OIDC-over-static credentials, Sigstore/Rekor supply-chain verification, and live docs via Context7. Auto-loads for any CI/CD, IaC, Kubernetes, or SRE task.
---
