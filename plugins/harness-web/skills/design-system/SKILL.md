...
description: Conventions for a shared component library consumed by two or more apps. Use when .claude/HARNESS.toml selects web/design-system, or when building a versioned React/Vue/Svelte component library with design tokens, Storybook stories, visual regression, and accessibility as the leverage point.
---
