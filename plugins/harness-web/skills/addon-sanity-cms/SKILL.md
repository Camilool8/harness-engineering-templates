---
name: web-addon-sanity-cms
description: Sanity CMS conventions — fetching with a pinned apiVersion @sanity/client, typed GROQ via defineQuery + typegen, Portable Text and image-url rendering, and env-var-only tokens with MCP output treated as untrusted. Use when integrating Sanity content or querying the Content Lake. The Sanity MCP server ships with this plugin.
---
