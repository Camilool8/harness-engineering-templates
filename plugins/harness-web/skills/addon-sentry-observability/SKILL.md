---
name: web-addon-sentry-observability
description: Sentry error and performance monitoring conventions — MCP output treated as untrusted, public DSN vs secret auth token handling, PII data minimization with beforeSend, and production trace sampling. Use when instrumenting Sentry or investigating production errors. The Sentry MCP server ships with this plugin.
---
