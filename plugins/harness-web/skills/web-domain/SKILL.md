---
name: web-domain
description: Shared rules for any web engineering work — trust model, non-negotiable accessibility (verify the a11y tree not screenshots, axe-core WCAG 2.2 AA), live docs via Context7, and a hard Core Web Vitals budget. Auto-loads for any frontend, API, or fullstack task.
---
