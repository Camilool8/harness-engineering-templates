---
name: practicing-tdd
description: Drives deterministic code red-green-refactor. Use before writing or changing any implementation file — write a failing test first, watch it fail, write minimal code to pass, then refactor.
---

# Practicing TDD

The `tdd-guard.sh` hook will block edits to implementation files until you have
observed a real failing test. Work the cycle; the gate is on your side.
